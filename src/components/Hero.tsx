    ...
    <section ref={heroRef} className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div
        className={`hero-shape morph-shape-1 absolute top-20 left-20 w-32 h-32 rounded-full opacity-20 ${
          isDark ? "bg-gradient-to-br from-blue-400 to-purple-400" : "bg-gradient-to-br from-blue-200 to-purple-200"
        }`}
      ></div>
      <div
        className={`hero-shape morph-shape-2 absolute bottom-20 right-20 w-24 h-24 rounded-full opacity-30 ${
          isDark ? "bg-gradient-to-br from-pink-400 to-yellow-400" : "bg-gradient-to-br from-pink-200 to-yellow-200"
        }`}
      ></div>
      <div
        className={`hero-shape morph-shape-3 absolute top-1/2 left-1/4 w-16 h-16 rounded-full opacity-25 ${
          isDark ? "bg-gradient-to-br from-green-400 to-blue-400" : "bg-gradient-to-br from-green-200 to-blue-200"
        }`}
      ></div>
      ...
      <div className="text-center max-w-4xl relative z-10">
        <h1
          className={`hero-name text-6xl md:text-8xl font-bold mb-4 tracking-tight bg-gradient-to-r ${
            isDark ? "from-white via-blue-400 to-purple-400" : "from-black via-blue-600 to-purple-600"
          } bg-clip-text text-transparent`}
        >
          AYOMIDE OLANIYAN
        </h1>
        <h2
          className={`hero-title text-2xl md:text-4xl font-light mb-6 ${isDark ? "text-slate-300" : "text-gray-600"}`}
        >
        ...
        >
          Crafting beautiful, interactive web experiences with modern technologies and creative animations
        </p>
        <div className="hero-cta flex gap-4 justify-center flex-wrap">
          <Button
            size="lg"
            className={`interactive ${
              isDark ? "bg-blue-600 hover:bg-blue-700 text-white" : "bg-black hover:bg-gray-800 text-white"
            }`}
          >
            View My Work
          </Button>
      ...
      <div
        className={`floating-2 absolute bottom-40 right-20 w-8 h-8 rounded-full parallax-medium ${
          isDark ? "bg-gradient-to-br from-purple-400 to-pink-400" : "bg-gradient-to-br from-purple-500 to-pink-500"
        }`}
      ></div>
      <div
      ...
      <div
        className={`floating-4 absolute top-1/3 right-1/4 w-3 h-3 rounded-full parallax-slow ${
          isDark ? "bg-gradient-to-br from-yellow-400 to-red-400" : "bg-gradient-to-br from-yellow-500 to-red-500"
        }`}
      ></div>
      <div
        className={`floating-5 absolute bottom-1/3 left-1/4 w-5 h-5 rounded-full parallax-medium ${
          isDark ? "bg-gradient-to-br from-indigo-400 to-purple-400" : "bg-gradient-to-br from-indigo-500 to-purple-500"
        }`}
      ></div>
    </section>
  );
