...
export default function Home() {
  ...
  // Sync dark class on html element for Tailwind and custom CSS selectors
  useEffect(() => {
    if (isDark) {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 pt-16 ${isDark ? "bg-slate-900 text-slate-100" : "bg-white text-gray-900"}`}
    >
      {/* Scroll Progress Bar */}
